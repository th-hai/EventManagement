...
const ContainerLarge = () => {
    ...
    <div class="relative w-1/2 h-full pl-12">
        <p class="text-sm font-bold tracking-wide text-indigo-500 uppercase">Awesome Features</p>
        <h2 class="mt-5 text-4xl font-bold leading-tight text-gray-900">Awesome Features<br/> for Everyone to Enjoy.</h2>
        <p class="mt-3 text-base text-gray-600">Perhaps the coolest features since the introduction of Poprocks! We've
            got
            some rock'n poppin features that will leave you wanting more. We've got a jampacked feature set of
            awesomeness
            that will blow your pants right off!</p>
