...
const Intro = () => {
  return (
    <div class="flex items-center justify-center  p-5  w-screen h-3/5 mt-24" >
      <div class="relative flex flex-col items-center w-10/12 px-4 py-8  text-center rounded-lg shadow-2xl lg:text-left lg:block bg-gradient-to-br from-purple-600 via-indigo-500 to-teal-400 sm:px-6 md:pb-0 md:pt-12 lg:px-12 lg:py-12">
