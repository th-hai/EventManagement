        ...
        <header class="w-full text-gray-700 bg-white  border-gray-100 shadow-sm body-font top-0 z-40 fixed sticky ">
            <div class="container flex flex-col items-start justify-between p-6 mx-auto md:flex-row ">
                ...
                <div class="items-center ">
                    <a class="font-medium hover:text-gray-900 mr-5">
                    ...
                    <a class="mr-5 font-medium hover:text-gray-900">
                        {
                            isLogged ? (isAdmin ? <Link to="/dashboard">{`${user.name} - Admin`} </Link> : <Link to="/profile">{user.name} </Link>): <Link to="/login">Login</Link>
                    ...
                    <a
                        ...
                        {
                            isLogged ? <Link to="/" onClick={handleLogout}>Log out</Link> : <Link to="/register">Sign up</Link>
                        }
